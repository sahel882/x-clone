import { View, Text, Alert, TouchableOpacity, TextInput, ScrollView, Image, ViewComponent, Modal } from 'react-native'
    ...
    <SafeAreaView className='flex-1 bg-white' edges={["top"]}>
      ...
      >
        {conversationList.map(conversation => (
          <TouchableOpacity
            key={conversation.id}
            className='flex-row items-center p-4 border-b border-gray-50 activity:bg-gray-50'
